...
스왑은 부족한 램을 보충해 줄 수 있는 수단은 아니고, 메모리 넘칠 때 충격을 좀 완화해줄 수 있는 정도의 역할만 합니다.
...
하드디스크라면 60 그대로 두어도 되는데, SSD 라면 10~30 으로 하는 게 낫습니다.
이렇게 하면 램이 거의 다 찰 때까지 스왑을 활용하지 않게 되고 SSD의 쓰기 수명을 조금이라도 아낄 수 있습니다.

저는 SSD 에서 보통 10을 줍니다. 즉 램 90%가 차면 스왑을 고려하게 됩니다.
